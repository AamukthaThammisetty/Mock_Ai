    ...
    const contactMethods = [
        {
            ...
            desc: "Our AI-based system will help you sharpen your interview skills with real-time feedback.",
            link: {
                name: "Start Mock Interview",
                href: "/mock-interview"  // Link to the mock interview page
            },
        },
        {
            icon:
            ...
            desc: "Monitor your mock interview scores and areas to improve with detailed analytics and feedback.",
            link: {
                name: "View Your Progress",
                href: "/progress-dashboard"  // Link to the progress page
            },
        },
    ];
        ...
        <section className="py-14 bg-gray-50">
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 gap-12 md:px-8 lg:flex">
                <div className="max-w-md">
                    ...
                    <p className="mt-3">
                        Whether you're preparing for a technical interview, a behavioral interview, or both, we have the tools to help you succeed. Get started now!
                    </p>
                </div>
                <div>
