          ...
          {interviewDetails ? (
              <div className="grid grid-cols-2 gap-6 bg-white p-8 rounded-lg  w-full  text-left">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-700"><strong>Job
                    Position/Role:</strong> {interviewDetails.jobPosition}</h3>
                  ...
                  <Alert variant="info" className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <AlertDescription>
                        Enable your webcam and microphone to start your AI-generated mock interview. You’ll receive five
                        questions to answer, and at the end, a report based on your responses. Note: We do not record
                        your video, and you can disable the webcam at any time.
                      </AlertDescription>
                    </div>
                  </Alert>
                </div>
